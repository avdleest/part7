...
const Menu = ({ anecdotes, addNew, anecdoteById, handleNotification, notification }) => {
  const padding = {
    paddingRight: 5
  }
    ...
    <div>
      <div>
        <Router>
          ...
          <Route path='/create' render={() => <CreateNew addNew={addNew} handleNotification={handleNotification} />} />
...
const CreateNewNoHistory = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.history.push('/')
    props.handleNotification(`A new anecdote added: ${content}`)
  }
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Menu anecdotes={anecdotes} addNew={addNew} anecdoteById={anecdoteById} handleNotification={handleNotification} notification={notification} />
      <Footer />
    </div>
  )
}
